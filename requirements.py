...
AMULET_LEVELDB_REQUIREMENT = "~=3.0.1.0a0"
...
AMULET_GAME_REQUIREMENT = "~=1.0.1.0a0"
AMULET_ANVIL_REQUIREMENT = "~=1.0.1.0a0"
AMULET_LEVEL_REQUIREMENT = "~=1.0.1.0a0"
AMULET_RESOURCE_PACK_REQUIREMENT = "~=1.0.1.0a0"
NUMPY_REQUIREMENT = "~=2.0"
PIL_REQUIREMENT = "~=11.3"
PYOPENGL_REQUIREMENT = "~=3.1"
AMULET_RUNTIME_FINAL_REQUIREMENT = "~=1.1"
PYSIDE6_REQUIREMENT = "~=6.9"
