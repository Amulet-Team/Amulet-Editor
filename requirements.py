...
AMULET_CORE_REQUIREMENT = "~=2.0.3.0a2"
AMULET_GAME_REQUIREMENT = "~=1.0.0.0a4"
AMULET_ANVIL_REQUIREMENT = "~=1.0.0.0a3"
AMULET_LEVEL_REQUIREMENT = "~=1.0.0.0a2"
AMULET_RESOURCE_PACK_REQUIREMENT = "~=1.0.0.0a2"
