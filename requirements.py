...
AMULET_CORE_REQUIREMENT = "~=2.0.7.0a0"
AMULET_RESOURCE_PACK_REQUIREMENT = "~=1.0.3.0a0"
AMULET_GAME_REQUIREMENT = "~=1.0.2.0a5"
AMULET_ANVIL_REQUIREMENT = "~=1.0.3.0a1"
