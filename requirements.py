...
AMULET_LEVELDB_REQUIREMENT = "~=3.0.7.0a0"
AMULET_UTILS_REQUIREMENT = "~=1.1.5.0a"
AMULET_ZLIB_REQUIREMENT = "~=1.0.11.0a0"
AMULET_NBT_REQUIREMENT = "~=5.0.5.0a0"
AMULET_CORE_REQUIREMENT = "~=2.0.10.0a0"
AMULET_RESOURCE_PACK_REQUIREMENT = "~=1.0.6.0a0"
AMULET_GAME_REQUIREMENT = "~=1.0.6.0a0"
AMULET_ANVIL_REQUIREMENT = "~=1.0.6.0a0"
AMULET_LEVEL_REQUIREMENT = "~=1.0.7.0a0"
NUMPY_REQUIREMENT = "~=2.0"
PIL_REQUIREMENT = "~=11.3"
OPENGL_REQUIREMENT = "~=3.1"
RUNTIME_FINAL_REQUIREMENT = "~=1.1"
PYSIDE6_REQUIREMENT = "==6.11.1"
PACKAGING_REQUIREMENT = "~=25.0"
...
if os.environ.get("AMULET_LEVEL_REQUIREMENT", None):
...
def get_runtime_dependencies(sdist: bool = False) -> list[str]:
    return [
        ...
        f"amulet-runtime-final{RUNTIME_FINAL_REQUIREMENT}",
        f"PySide6-Essentials{PYSIDE6_REQUIREMENT}",
        f"packaging{PACKAGING_REQUIREMENT}",
    ]
