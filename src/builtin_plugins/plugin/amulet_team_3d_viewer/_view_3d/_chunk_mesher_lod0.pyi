...
import plugin.amulet_team_3d_viewer._view_3d._resource_pack_base

__all__ = ["create_lod0_chunk"]

def create_lod0_chunk(
    resource_pack: plugin.amulet_team_3d_viewer._view_3d._resource_pack_base.AbstractOpenGLResourcePack,
    cx: int,
    cz: int,
